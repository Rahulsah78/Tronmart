        ...
        <>
            <div className='p-5 md:px-10 flex flex-col items-center md:h-screen bg-[#F7FAFD] w-full'>
                ...
                <div className="md:mt-10 mt-[89vw] mb-10 w-full">
                    ...
                    <div className="h-[11vw] overflow-hidden border flex items-center justify-start gap-6 bg-white shadow-sm">
                        {
                            logo.map((item, index) => (
                                <div key={index} className='flex border-r-2 items-center justify-center h-full w-[20%]'>
