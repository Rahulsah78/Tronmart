...
import pcandlaptop from "../../AlllJsonData/PcAndLaptop/PcAndLaptop.json"
        ...
        <>
            <div className='p-5 md:px-10 shadow-md flex items-center  min-h-screen bg-[#F7FAFD]'>
                <div className='px-5 shadow-md bg-white h-full '>
                    <h1 className='pt-4 text-2xl font-bold'>PCs & Laptop</h1>
                                ...
                                pcandlaptop.map((item, index) => {
                                    ...
                                    return (
                                        <div data-aos="fade-up" key={index} className='overflow-hidden relative  md:h-[39vw] md:w-[22vw] mb-6 group'>
                                            <Link to={`/pc_laptopdetails/${item.id}`} className='flex flex-col items-center'>
