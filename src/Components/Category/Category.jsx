...
const Category = () => {
    ...
    return (
        <>
            <div className="md:p-10 p-5 bg-[#F7FAFD] min-h-screen">
                <div className="h-full border flex items-center flex-wrap justify-between mt-5 bg-white">
                    {categories.map((item, index) => (
                        <div key={index} className="md:h-[25vw] w-64 mb-6 flex justify-center items-center mx-auto">
                            <Link to={item.link} className="flex flex-col md:items-center items-center text-center">
                ...
                <div className="h-44 mt-14 flex flex-col md:flex-row items-center gap-5">
                    <div className="h-full md:w-1/2 w-full">
                        <img className="h-full w-full object-cover" src="/images/electronic-banner-2.jpg" alt="" />
                    </div>
                    <div className="h-full md:w-1/2 w-full">
                        <img className="h-full w-full object-cover" src="/images/electronic-banner-1.jpg" alt="" />
                    </div>
                </div>
