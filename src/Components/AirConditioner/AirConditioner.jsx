...
const AirConditioner = () => {
    ...
    return (
        <>
            <div className='md:px-10 p-5 flex flex-col items-center min-h-screen bg-[#F7FAFD]'>
                <div className='px-5 shadow-md bg-white h-full'>
                    <h1 className='pt-4 text-2xl font-bold'>Air conditioner</h1>
                    <div className='flex gap-5 items-center justify-between'>

                        {/* Flex layout: 'flex-col' for mobile and 'flex-row' for larger screens */}
                        <div className='h-full flex flex-col md:flex-row gap-[5px] items-center flex-wrap justify-between mt-5 bg-ore-500'>
                            {airconditioner.map((item, index) => {
                                return (
                                    <div data-aos="fade-up" key={index} className='overflow-hidden relative md:h-[39vw] md:w-[22vw] mb-6 group'>
                                        <Link to={`/airconditionerdetails/${item.id}`} className='flex flex-col items-center'>
                ...
                <div className='h-36 mt-10 mb-10 bg-[url(/AirConditioner/promotional-banner2.jpg)] bg-cover md:bg-object-cover object-contain w-full'></div>
