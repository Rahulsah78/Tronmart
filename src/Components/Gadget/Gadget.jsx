                                ...
                                gadgetdata.map((item, index) => {
                                    ...
                                    return (
                                        <div data-aos="fade-up" key={index} className='overflow-hidden relative  md:h-[39vw] md:w-[22vw] mb-6 group'>
                                            ...
                                            {/* Sale Badge */}
                                            {
                                                index == 3 ? <span className="py-2 px-6 font-bold rounded-[50px] bg-white text-blue-500 shadow-md text-xs absolute top-3 left-3">
                                                    Sale
                                                </span>
                                                    :
                                                    ""
